  ...
  return (
    ...
    >
      ...
      <div className="h-full overflow-y-scroll lg:flex" ref={containerRef}>
        {/* Text container */}
        <div className="p-4  sm:p-8 md:p-12 lg:p-20  xl:p-35 xl:pt-20 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          {/* Biography container */}
          <div className="flex flex-col gap-12 justify-center">
            <h1 className="font-bold text-2xl">Summary</h1>
            <p className="text-lg hyphens-auto">
              As an experienced Front-End Developer, I specialize in creating
              modern and responsive user interfaces using industry leading
              technologies such as React and Next.js. With a strong foundation
              in web development, I am dedicated to crafting visually appealing,
              high-performance websites and applications that deliver
              exceptional user experiences. My pro ciency in these frameworks
              allows me to turn innovative ideas into functional, user-centric
              digital solutions, contributing to the success of projects and
              organizations
            </p>
            {/* Biography quote */}
          ...
          <div
            className=" flex-1 flex flex-col gap-12 justify-center pb-48"
            ref={experienceRef}
          >
            {/* Experience title */}
            <motion.h1
                  ...
                  return (
                    <div key={index + Math.random()*500000} className="flex justify-between h-auto">
                      ...
                      <div className="w-1/3">
                        ...
                        {/* Job Desc */}
                        {/* <div className="p-3 text-sm italic">{item.jobDesc}</div> */}
